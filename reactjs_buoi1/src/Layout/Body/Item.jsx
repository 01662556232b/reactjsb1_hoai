                    ...
                    <div className="row gx-lg-5">
                        <div className="col-lg-6 col-xxl-4 mb-5">
                            <div className="card bg-light border-0 h-100">
                                <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                    <div className="healer bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4">
                        ...
                        <div className="col-lg-6 col-xxl-4 mb-5">
                            <div className="card bg-light border-0 h-100">
                                <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                    <div className="healer bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4">
                                        <i className="fa-solid fa-b" /></div>
                                    <h2 className="fs-4 fw-bold">healer boxes</h2>
                                    <p className="mb-0">We've created some custom healer boxes using Bootstrap icons!</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-xxl-4 mb-5">
                            <div className="card bg-light border-0 h-100">
                                <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                    <div className="healer bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4">
                                        <i className="fa-solid fa-code" /></div>
